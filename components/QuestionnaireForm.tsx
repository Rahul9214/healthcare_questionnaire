      ...
      <div className="container mx-auto px-2 py-4 max-w-4xl">
        <div className="form-container rounded-lg shadow-xl watermark-bg">
          <div className="text-center border-b border-healthcare-200 pb-4 mb-6">
            ...
            />
            <h1 className="text-2xl font-bold text-healthcare-700 mb-1">Preventive Healthcare & Wellness Centre</h1>
            <h2 className="text-lg font-semibold hindi-text text-healthcare-600 mb-3">निवारक स्वास्थ्य और कल्याण केंद्र</h2>
            <div className="flex items-center justify-center space-x-3 mb-3">
              <div className="w-8 h-0.5 bg-healthcare-500 rounded-full"></div>
              <span className="text-sm font-medium text-healthcare-700">Patient Questionnaire / रोगी प्रश्नावली</span>
              <div className="w-8 h-0.5 bg-healthcare-500 rounded-full"></div>
            </div>
            <p className="text-xs text-medical-600 bg-healthcare-50 rounded-md p-2 border border-healthcare-200">
              (For AIIMS Delhi alumni services in Chhatarpur area — OPD, Daycare, Super-speciality, Diagnostics,
              CGHS/CAPF support, Generic Medicines)
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-6">
            <div className="bg-healthcare-50 p-4 rounded-lg border-l-3 border-healthcare-500">
              ...
              <p className="text-xs text-medical-700 mb-2 leading-relaxed">
                We want to understand local healthcare needs and improve services. Your answers will help set up
                reliable, affordable, and trustworthy care in Chhatarpur.
              </p>
              <p className="hindi-text text-xs text-medical-700 leading-relaxed">
                हम आपके इलाके की स्वास्थ्य ज़रूरतें समझना चाहते हैं ताकि Chhatarpur में भरोसेमंद और सस्ती सेवाएँ दी जा सकें।
              </p>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            {/* Question 2 */}
            <div className="question-group print-avoid-break">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">2. If NO, why? (Choose all that apply)</h3>
              <p className="hindi-text text-gray-700 mb-4">अगर नहीं, तो वजह क्या थी? (सभी लागू विकल्प चुनें)</p>
              <div className="space-y-2">
                {[
            ...
            <div className="question-group print-avoid-break">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { value: "daycare", label: "Daycare treatments (minor procedures) / डेकेयर ट्रीटमेंट (छोटी प्रक्रियाएँ)" },
                  {
                  ...
                  {
                    value: "diagnostic",
                    label: "Diagnostic lab & imaging (reliable tests) / डायग्नोस्टिक लैब और इमेजिंग (भरोसेमंद टेस्ट)",
                  },
                  { value: "cghs-support", label: "CGHS / CAPF empanelment support / CGHS / CAPF सहायता" },
            ...
            <div className="question-group print-avoid-break">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">
                7. What is an acceptable average cost for a routine blood test package (basic checkup) for families
                here?
              </h3>
              <p className="hindi-text text-gray-700 mb-4">
                यहाँ परिवार के लिए सामान्य ब्लड टेस्ट पैकेज की स्वीकार्य औसत लागत क्या है? (रु में)
              </p>
              <div className="space-y-2">
                {[
            ...
            <div className="question-group print-avoid-break">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">
                8. Would you prefer generic medicines dispensed at the centre (cheaper) if quality assured?
              </h3>
              <p className="hindi-text text-gray-700 mb-4">
                अगर गुणवत्तापूर्ण सुनिश्चित हो तो क्या आप सेंटर पर जेनेरिक दवाइयाँ लेना पसंद करेंगे (सस्ती होती हैं)?
              </p>
              <div className="space-y-2">
                {[
            ...
            <div className="question-group print-avoid-break">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">
                9. Which hours are best for you to visit the wellness centre? (Choose all that apply)
              </h3>
              <p className="hindi-text text-gray-700 mb-4">किस समय आप वेलनेस सेंटर आना पसंद करेंगे? (सभी लागू विकल्प चुनें)</p>
              <div className="space-y-2">
                {[
            ...
            <div className="question-group print-avoid-break">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">
                10. Would you like community health awareness sessions (free) on topics like diabetes, hypertension,
                women's health, child vaccination?
              </h3>
              <p className="hindi-text text-gray-700 mb-4">
                क्या आप मुफ्त सामुदायिक स्वास्थ्य जागरूकता सत्र चाहेंगे (शुगर, ब्लड प्रेशर, महिलाओं का स्वास्थ्य, बच्चों का टीकाकरण आदि)?
              </p>
            ...
            {/* Feedback Section */}
            <div className="question-group print-avoid-break">
              <h3 className="text-lg font-semibold text-medical-700 mb-3">Feedback & Contact / सुझाव और संपर्क</h3>
              <div className="mb-4">
                <label className="block">
                  <span className="text-gray-700 mb-2 block">
                    Please give any suggestions or concerns you have about local healthcare (short):
                  </span>
                  <span className="hindi-text text-gray-700 mb-2 block">
                    कृपया स्थानीय स्वास्थ्य सेवाओं के बारे में अपने सुझाव/चिंताएँ लिखें (संक्षेप):
                  </span>
                  <textarea
              ...
              <div className="mb-4">
                <p className="text-gray-700 mb-2">Would you like a follow-up call or message about the new centre?</p>
                <p className="hindi-text text-gray-700 mb-4">क्या आप नए केंद्र के बारे में फोन या संदेश से फॉलो‑अप चाहते हैं?</p>
                <div className="space-y-2 mb-4">
                  <label className="flex items-center">
                    <input
                      type="radio"
              ...
              <div className="mb-4">
                <p className="text-gray-700 mb-2">Overall satisfaction with local healthcare today (1-5):</p>
                <p className="hindi-text text-gray-700 mb-4">आज के स्थानीय स्वास्थ्य सेवाओं से समग्र संतुष्टि (1-5):</p>
                <div className="flex space-x-6">
