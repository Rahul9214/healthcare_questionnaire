  ...
  const getRankingAnswers = (): string => {
    ...
    const services: Option[] = [
      ...
      { value: "daycare", label: "Daycare treatments / डेकेयर ट्रीटमेंट" },
      {
        ...
        label: "Super‑speciality consultations / सुपर‑स्पेशलिटी परामर्श",
      },
      {
        value: "diagnostic",
        label: "Diagnostic lab & imaging / डायग्नोस्टिक लैब और इमेजिंग",
      },
      {
        value: "cghs-support",
        label: "CGHS / CAPF support / CGHS / CAPF सहायता",
      },
      {
    ...
    const ranked = Object.entries(formData.services_needed)
      ...
      .sort(
        ([_, a], [__, b]) =>
          Number.parseInt(a as string) - Number.parseInt(b as string)
      )
      .map(([service, rank]) => {
    ...
    <div className="min-h-screen bg-medical-50">
      ...
      <div className="no-print bg-healthcare-600 text-white p-4 flex justify-between items-center shadow-lg print-button">
        ...
        <div className="flex items-center space-x-3">
          <img
            src="/images/ziagnosis-logo-watermark.png"
            alt="Ziagnosis"
            className="w-10 h-10 rounded-full shadow-md"
          />
          <h2 className="text-2xl font-bold gradient-text drop-shadow">
            Questionnaire Response / प्रश्नावली प्रतिक्रिया
          </h2>
        </div>
        <button
          onClick={onPrint}
      ...
      <div className="container mx-auto px-2 py-4 max-w-3xl watermark-bg">
        <div className="form-container bg-white rounded-xl shadow-xl p-4">
          ...
          <div className="text-center mb-6 border-b border-healthcare-200 pb-4">
            ...
            />
            <h1 className="text-3xl font-extrabold gradient-text mb-1 drop-shadow">
              Preventive Healthcare & Wellness Centre
            </h1>
            <h2 className="text-xl font-bold hindi-text text-healthcare-600 mb-2 drop-shadow">
          ...
          <div className="space-y-4">
            ...
            <div className="question-group print-avoid-break shadow-sm">
              <h3
                ...
                style={{
                  background:
                    "linear-gradient(90deg, #2563eb 0%, #059669 60%, #1d4ed8 100%)",
              ...
              >
                1. Have you visited any trained doctor (MBBS/MD/AIIMS alumni) in
            ...
            <div className="question-group print-avoid-break">
              ...
              <p className="hindi-text text-gray-700 mb-2">
                CGHS/CAPF सेवाएँ आपके लिए कितनी ज़रूरी हैं?
              </p>
              <p className="font-medium text-healthcare-700 bg-healthcare-50 p-2 rounded border-l-4 border-healthcare-500">
                Answer / उत्तर:{" "}
                {formData.cghs_importance
                  ? `${formData.cghs_importance}/5`
                  : "Not answered"}
              </p>
            </div>
            ...
            <div className="question-group print-avoid-break">
              ...
              >
                8. Would you prefer generic medicines dispensed at the centre if
                quality assured?
              </h3>
              <p className="hindi-text text-gray-700 mb-2">
                अगर गुणवत्तापूर्ण सुनिश्चित हो तो क्या आप सेंटर पर जेनेरिक
                दवाइयाँ लेना पसंद करेंगे?
              </p>
              <p className="font-medium text-healthcare-700 bg-healthcare-50 p-2 rounded border-l-4 border-healthcare-500">
                Answer / उत्तर:{" "}
            ...
            <div className="question-group print-avoid-break">
              ...
              <p className="hindi-text text-gray-700 mb-2">
                किस समय आप वेलनेस सेंटर आना पसंद करेंगे?
              </p>
              <p className="font-medium text-healthcare-700 bg-healthcare-50 p-2 rounded border-l-4 border-healthcare-500">
                Answer / उत्तर:{" "}
            ...
            <div className="question-group print-avoid-break">
              ...
              <p className="hindi-text text-gray-700 mb-2">
                क्या आप मुफ्त सामुदायिक स्वास्थ्य जागरूकता सत्र चाहेंगे?
              </p>
              <p className="font-medium text-healthcare-700 bg-healthcare-50 p-2 rounded border-l-4 border-healthcare-500">
                Answer / उत्तर:{" "}
            ...
            <div className="question-group print-avoid-break">
              ...
              <p className="font-medium text-healthcare-700 bg-healthcare-50 p-3 rounded border-l-4 border-healthcare-500">
                {formData.feedback ||
                  "No feedback provided / कोई सुझाव नहीं दिया गया"}
              </p>
            </div>
            ...
            <div className="question-group print-avoid-break">
              ...
              >
                Overall satisfaction with local healthcare today / आज के स्थानीय
                स्वास्थ्य सेवाओं से समग्र संतुष्टि
              </h3>
              <p className="font-medium text-healthcare-700 bg-healthcare-50 p-2 rounded border-l-4 border-healthcare-500">
            ...
            <div className="question-group print-avoid-break">
              ...
              <div className="space-y-2 bg-healthcare-50 p-3 rounded border-l-4 border-healthcare-500">
                ...
                <p className="font-medium text-healthcare-700">
                  Contact / संपर्क:{" "}
                  {formData.contact || "Not provided / नहीं दिया गया"}
                </p>
                <p className="font-medium text-healthcare-700">
                  Address / पता:{" "}
                  {formData.address || "Not provided / नहीं दिया गया"}
                </p>
                <p className="font-medium text-healthcare-700">
                  Local area / स्थानीय क्षेत्र:{" "}
                  {formData.area || "Not provided / नहीं दिया गया"}
                </p>
                <p className="font-medium text-healthcare-700">
                  Emergency Contact / आपातकालीन संपर्क:{" "}
                  {formData.emergency_contact || "Not provided / नहीं दिया गया"}
                </p>
                <p className="font-medium text-healthcare-700">
                  Blood Group / रक्त समूह:{" "}
                  {formData.blood_group || "Not provided / नहीं दिया गया"}
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="text-right">
                <div className="space-y-1">
                  <div className="flex items-center justify-end space-x-2">
                    ...
                    <span className="text-xs font-semibold text-healthcare-700">
                      www.ziagnosis.com
                    </span>
                  </div>
                  <div className="flex items-center justify-end space-x-2">
                  ...
                  <div className="flex items-center justify-end space-x-2 text-xs">
                    ...
                    <div className="social-row">
                      <div className="flex items-center space-x-1">
                        ...
                        <div className="w-4 h-4 bg-gradient-to-r from-blue-600 to-blue-700 rounded-sm flex items-center justify-center">
                          <svg
                            className="w-3 h-3 text-white"
                            fill="currentColor"
                            viewBox="0 0 24 24"
                        ...
                        <div className="w-4 h-4 bg-gradient-to-r from-blue-400 to-blue-500 rounded-sm flex items-center justify-center">
                          <svg
                            className="w-3 h-3 text-white"
                            fill="currentColor"
                            viewBox="0 0 24 24"
                        ...
                        <div className="w-4 h-4 bg-gradient-to-r from-blue-700 to-blue-800 rounded-sm flex items-center justify-center">
                          <svg
                            className="w-3 h-3 text-white"
                            fill="currentColor"
                            viewBox="0 0 24 24"
                        ...
                        <div className="w-4 h-4 bg-gradient-to-r from-red-600 to-red-700 rounded-sm flex items-center justify-center">
                          <svg
                            className="w-3 h-3 text-white"
                            fill="currentColor"
                            viewBox="0 0 24 24"
